...
# Fix get_prioritized_tasks method
old1 = '''    def get_prioritized_tasks(self, limit: int = 10) -> List[Dict]:
        return orchestrator.get_prioritized_tasks(limit)'''

new1 = '''    def get_prioritized_tasks(self, limit: int = 10) -> List[Dict]:
...
# Fix suggest_schedule method
old2 = '    def suggest_schedule(self, date: str = None) -> Dict:\n        return orchestrator.suggest_schedule(date)'
new2 = '''    def suggest_schedule(self, date: str = None) -> Dict:
...
# Fix morning_briefing method
old3 = '    def morning_briefing(self) -> str:\n        return orchestrator.morning_briefing()'
new3 = '''    def morning_briefing(self) -> str:
...
# Fix evening_review method
old4 = '    def evening_review(self) -> str:\n        return orchestrator.evening_review()'
new4 = '    def evening_review(self) -> str:\n        return "Evening review - to be implemented"'
...
with open(r'C:\Users\LENOVO\Videos\JARVIS\core\multi_agent.py', 'w', encoding='utf-8') as f:
    f.write(content)
print('Fixed orchestrator methods')