...
old = 'task_id = "task_{:08d}".format(int(time.time() * 1000000) % 100000000) + "_{:04d}".format(int(time.time() * 10000) % 10000)'
new = 'task_id = "task_{:08d}".format(int(time.time() * 1000000) % 100000000) + "_{:04d}".format(int(time.time() * 10000) % 10000) + "_{:04d}".format(random.randint(0, 9999))'
