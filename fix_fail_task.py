# Fix the fail_task method in multi_agent.py
...
if idx >= 0:
    ...
    new_fail_task = '''def fail_task(self, task_id: str, error: str):
    ...
    new_content = content[:content.index('def fail_task')] + new_fail_task + content[content.index('def get_task_status', content.index('def fail_task')):]
