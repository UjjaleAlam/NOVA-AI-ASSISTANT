with open(r'C:\Users\LENOVO\Videos\JARVIS\core\executive_assistant.py', 'r') as f:
    content = f.read()
...
with open(r'C:\Users\LENOVO\Videos\JARVIS\core\executive_assistant.py', 'w') as f:
    f.write(content)
